  ...
  return (
    ...
    >
      <Layout.Header>
        ...
        >
          <Col span={6}>
            <div className="bg-gray-400 inline px-5 py-4 overflow-hidden">app logo</div>
          </Col>
          <Col flex={1}>
            <Input
              placeholder="How to switch theme.."
              size="large"
            />
          </Col>
              ...
              <Space>
                ...
                >
                  ...
                  >
                    <Space size={4}>
                      <Avatar src={avatar} />
                      <Typography.Text>Khuong Duy</Typography.Text>
                    </Space>
                  </Button>
                </Popover>
                <Popover
