...
import {FireTwoTone, GithubOutlined, SettingOutlined, StarTwoTone} from '@ant-design/icons';
        ...
        <Layout.Header>
          ...
          >
            ...
            <Col flex={1}>
              ...
              >
                <Input placeholder="How to switch theme.." />
              </ConfigProvider>
            </Col>
                ...
                <Space>
                  ...
                  >
                    ...
                    >
                      <Space size={4}>
                        <Avatar src={avatar} />
                        <Typography.Text type="secondary">Khuong Duy</Typography.Text>
                      </Space>
                    </Button>
                  </Popover>
                  <Popover
                    content={
                      <Layout className="h-80">
                        <Typography.Text>Theme setting,color palette,..</Typography.Text>
                        <Button
                        ...
                        <Space>
                          <Typography.Text className="min-w-[60px]">
