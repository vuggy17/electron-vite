...
if (fs.existsSync(path.join(__dirname, 'NodeRT_Windows_Graphics_Imaging.d.js)'))) {
  module.exports = require('./NodeRT_Windows_Graphics_Imaging.d.js');
} else {
  module.exports = require('../build/Release/binding.node');
}

var externalReferencedNamespaces = ['Windows.Foundation', 'Windows.Storage.Streams', 'Windows.Graphics.DirectX.Direct3D11'];
