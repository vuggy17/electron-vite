...
declare module '@nodert-win11-22h2/windows.graphics.imaging' {
  ...
  export class BitmapDecoder {
    ...
    static createAsync(
      stream: Object,
      callback: (error: Error, result: BitmapDecoder) => void
    ): void;
    static createAsync(
      decoderId: string,
      stream: Object,
    ...
    getPreviewAsync(
      callback: (error: Error, result: ImageStream) => void
    ): void;

    getFrameAsync(
      frameIndex: number,
      callback: (error: Error, result: BitmapFrame) => void
    ): void;
    ...
    getPixelDataAsync(
      callback: (error: Error, result: PixelDataProvider) => void
    ): void;
    getPixelDataAsync(
    ...
    getSoftwareBitmapAsync(
      callback: (error: Error, result: SoftwareBitmap) => void
    ): void;
    getSoftwareBitmapAsync(
      pixelFormat: BitmapPixelFormat,
      alphaMode: BitmapAlphaMode,
  ...
  export class BitmapEncoder {
    ...
    static createAsync(
      encoderId: string,
      stream: Object,
      callback: (error: Error, result: BitmapEncoder) => void
    ): void;
    static createAsync(
      encoderId: string,
      stream: Object,
  ...
  export class BitmapProperties {
    ...
    setPropertiesAsync(
      propertiesToSet: Object,
      callback: (error: Error) => void
    ): void;

    getPropertiesAsync(
      propertiesToRetrieve: Object,
      callback: (error: Error, result: BitmapPropertySet) => void
    ): void;
  }
