...
if (fs.existsSync(path.join(__dirname, 'NodeRT_Windows_Globalization.d.js)'))) {
  module.exports = require('./NodeRT_Windows_Globalization.d.js');
} else {
  module.exports = require('../build/Release/binding.node');
}

var externalReferencedNamespaces = ['Windows.System'];
