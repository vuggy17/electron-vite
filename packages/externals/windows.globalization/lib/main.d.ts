...
declare module '@nodert-win11-22h2/windows.globalization' {
  export class GlobalizationJapanesePhoneticAnalyzerContract {
    constructor();
  }
  ...
  export class ApplicationLanguages {
    ...
    static getLanguagesForUser(user: Object): Object;
  }
  ...
  export class Language {
    ...
    static getMuiCompatibleLanguageListFromLanguageTags(
      languageTags: Object
    ): Object;
