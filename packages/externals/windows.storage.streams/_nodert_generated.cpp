...
namespace NodeRT { namespace Windows { namespace Storage { namespace Streams { 
  ...
  v8::Local<v8::Value> WrapIPropertySetSerializer(::Windows::Storage::Streams::IPropertySetSerializer^ wintRtInstance);
  ::Windows::Storage::Streams::IPropertySetSerializer^ UnwrapIPropertySetSerializer(Local<Value> value);
  ...
  class IPropertySetSerializer : public WrapperBase {
    public:
      ...
      static void Init(const Local<Object> exports) {
        ...
        Local<FunctionTemplate> localRef = Nan::New<FunctionTemplate>(New);
        s_constructorTemplate.Reset(localRef);
        localRef->SetClassName(Nan::New<String>("IPropertySetSerializer").ToLocalChecked());
        localRef->InstanceTemplate()->SetInternalFieldCount(1);


          
            Nan::SetPrototypeMethod(localRef, "serialize", Serialize);
            Nan::SetPrototypeMethod(localRef, "deserialize", Deserialize);
        ...
        Nan::Set(exports, Nan::New<String>("IPropertySetSerializer").ToLocalChecked(), constructor);
      }
    ...
    private:
      ...
      IPropertySetSerializer(::Windows::Storage::Streams::IPropertySetSerializer^ instance) {
        _instance = instance;
      }
    ...
    static void New(Nan::NAN_METHOD_ARGS_TYPE info) {
      ...
      ::Windows::Storage::Streams::IPropertySetSerializer^ winRtInstance;


      if (info.Length() == 1 && OpaqueWrapper::IsOpaqueWrapper(info[0]) &&
        NodeRT::Utils::IsWinRtWrapperOf<::Windows::Storage::Streams::IPropertySetSerializer^>(info[0])) {
        try {
          winRtInstance = (::Windows::Storage::Streams::IPropertySetSerializer^) NodeRT::Utils::GetObjectInstance(info[0]);
        } catch (Platform::Exception ^exception) {
          NodeRT::Utils::ThrowWinRtExceptionInJs(exception);
          return;
        }
      ...
      IPropertySetSerializer *wrapperInstance = new IPropertySetSerializer(winRtInstance);
      wrapperInstance->Wrap(info.This());
    ...
    static void CastFrom(Nan::NAN_METHOD_ARGS_TYPE info) {
      HandleScope scope;
      if (info.Length() < 1 || !NodeRT::Utils::IsWinRtWrapperOf<::Windows::Storage::Streams::IPropertySetSerializer^>(info[0])) {
        Nan::ThrowError(Nan::Error(NodeRT::Utils::NewString(L"Invalid arguments, no object provided, or given object could not be casted to requested type")));
        return;
      }
      ...
      info.GetReturnValue().Set(WrapIPropertySetSerializer(winRtInstance));
    }
    ...
    static void Serialize(Nan::NAN_METHOD_ARGS_TYPE info) {
      ...
      if (!NodeRT::Utils::IsWinRtWrapperOf<::Windows::Storage::Streams::IPropertySetSerializer^>(info.This())) {
        return;
      }

      IPropertySetSerializer *wrapper = IPropertySetSerializer::Unwrap<IPropertySetSerializer>(info.This());
        ...
        && NodeRT::Utils::IsWinRtWrapperOf<::Windows::Foundation::Collections::IPropertySet^>(info[0]))
      {
        try
        {
          ...
          ::Windows::Storage::Streams::IBuffer^ result;
          result = wrapper->_instance->Serialize(arg0);
          info.GetReturnValue().Set(WrapIBuffer(result));
          return;
        } catch (Platform::Exception ^exception) {
          NodeRT::Utils::ThrowWinRtExceptionInJs(exception);
    ...
    static void Deserialize(Nan::NAN_METHOD_ARGS_TYPE info) {
      HandleScope scope;
        ...
        && NodeRT::Utils::IsWinRtWrapperOf<::Windows::Storage::Streams::IBuffer^>(info[1]))
      {
        ...
        {
          ::Windows::Foundation::Collections::IPropertySet^ arg0 = dynamic_cast<::Windows::Foundation::Collections::IPropertySet^>(NodeRT::Utils::GetObjectInstance(info[0]));
          ::Windows::Storage::Streams::IBuffer^ arg1 = UnwrapIBuffer(info[1]);
          
          wrapper->_instance->Deserialize(arg0, arg1);
          return;
        } catch (Platform::Exception ^exception) {
          NodeRT::Utils::ThrowWinRtExceptionInJs(exception);
          return;
    ...
    private:
      ::Windows::Storage::Streams::IPropertySetSerializer^ _instance;
      static Persistent<FunctionTemplate> s_constructorTemplate;

      friend v8::Local<v8::Value> WrapIPropertySetSerializer(::Windows::Storage::Streams::IPropertySetSerializer^ wintRtInstance);
      friend ::Windows::Storage::Streams::IPropertySetSerializer^ UnwrapIPropertySetSerializer(Local<Value> value);
  };

  Persistent<FunctionTemplate> IPropertySetSerializer::s_constructorTemplate;

  v8::Local<v8::Value> WrapIPropertySetSerializer(::Windows::Storage::Streams::IPropertySetSerializer^ winRtInstance) {
    EscapableHandleScope scope;
    ...
    Local<Value> opaqueWrapper = CreateOpaqueWrapper(winRtInstance);
    Local<Value> args[] = {opaqueWrapper};
    Local<FunctionTemplate> localRef = Nan::New<FunctionTemplate>(IPropertySetSerializer::s_constructorTemplate);
    return scope.Escape(Nan::NewInstance(Nan::GetFunction(localRef).ToLocalChecked(),_countof(args), args).ToLocalChecked());
  }

  ::Windows::Storage::Streams::IPropertySetSerializer^ UnwrapIPropertySetSerializer(Local<Value> value) {
     return IPropertySetSerializer::Unwrap<IPropertySetSerializer>(Nan::To<Object>(value).ToLocalChecked())->_instance;
  }

  void InitIPropertySetSerializer(Local<Object> exports) {
    IPropertySetSerializer::Init(exports);
  }
...
NAN_MODULE_INIT(init) {
  ...
  */
      ...
      NodeRT::Windows::Storage::Streams::InitIPropertySetSerializer(target);
