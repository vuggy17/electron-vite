...
if (fs.existsSync(path.join(__dirname, 'NodeRT_Windows_Media_Ocr.d.js)'))) {
  module.exports = require('./NodeRT_Windows_Media_Ocr.d.js');
} else {
  module.exports = require('../build/Release/binding.node');
}

var externalReferencedNamespaces = ['Windows.Globalization', 'Windows.Graphics.Imaging'];
